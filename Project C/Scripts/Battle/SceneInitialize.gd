...
func _ready():
	...
	play2 = Zurine.new($Player2, $Player2/AnimationGroup/Portrait, $Player2/AnimationGroup/HPBar/color, $Player2/AnimationGroup/EPBar/color, $Player2/AnimationGroup/HPBar/NumberSpace/Label, $Player2/AnimationGroup/EPBar/NumberSpace/Label, 30);
